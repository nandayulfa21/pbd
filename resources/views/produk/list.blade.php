...
@endsection
@section('konten')
<link rel="stylesheet" type="text/css" href="{{ url('DataTables/DataTables1.10.25/css/dataTables.bootstrap4.min.css') }}">
<form>
 <div class="row">
 <div class="col">
...
<th>Stok</th> <th>Harga</th> <th>Deskripsi</th> <th>Gambar</th> <th>OPSI</th> </tr></thead>" );
 }
</script>
